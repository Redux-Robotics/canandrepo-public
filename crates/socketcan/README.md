...
This is vendored/forked from [upstream](https://github.com/socketcan-rs/socketcan-rs), in order to incorporate [timestamped sockets](https://github.com/socketcan-rs/socketcan-rs/pull/77).

It is also explicitly placed outside the top-level workspaces because otherwise Cargo will screech at you if built on a non-Linux platform.
