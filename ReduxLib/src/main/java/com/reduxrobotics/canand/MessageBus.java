...
public class MessageBus {
     ...
     * 
     * For a spec of accepted instances, see this source code:
     * https://github.com/Redux-Robotics/canandrepo-public/blob/main/reduxfifo/fifocore/src/fifocore.rs#L110
     * 
     * (Yeah, yeah, we need to like, finish this.)
     * 
